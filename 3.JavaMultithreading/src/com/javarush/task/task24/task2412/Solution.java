    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                String nameS1 = (String)stock1.get ( "name" );
                String nameS2 = (String)stock2.get ( "name" );
                int comparableName = nameS1.compareTo ( nameS2 );
                ...
                double last1 = !stock1.containsKey("last") ? ((double) stock1.get("change")) : ((double) stock1.get("last"));
                double profit1 = last1 - open1;
                double open2 = !stock2.containsKey("open") ? 0 : ((double) stock2.get("open"));
                double last2 = !stock2.containsKey("last") ? ((double) stock1.get("change")) : ((double) stock2.get("last"));
                double profit2 = last2 - open2;
                int profitComparable;
                if (profit1 == profit2)
                    profitComparable = 0;
                else if (profit1 > profit2)
                    profitComparable = 1;
                else profitComparable = -1;

                return comparableName == 0 ? (compareDate == 0 ? profitComparable : compareDate) : comparableName;
            }
        });
    }
